...
import { MoneyList } from "@/components/game/MoneyList/MoneyList";
...
export function Sidebar({
  ...
  return (
    <>
      ...
      >
        <HeaderButton onClick={onClose} ariaLabel="Close menu">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
        ...
        <div className={styles.sidebarScroll}>
          <MoneyList money={money} activeIndex={activeIndex} />
        </div>
      </aside>
    </>
  );
